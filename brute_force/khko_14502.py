    ...
    while before_virus != after_virus:
        ...
        for i, row in enumerate(matrix):
            for j, element in enumerate(row):
                if element == 2:
                    # right
                    if (0 <= i+directions[0][0] < len(matrix)) and (0 <= j+directions[0][1] < len(matrix[0])):
                        if matrix[i+directions[0][0]][j+directions[0][1]] == 0:
                            matrix[i+directions[0][0]][j+directions[0][1]] = 2
                    # down
                    if (0 <= i+directions[1][0] < len(matrix)) and (0 <= j+directions[1][1] < len(matrix[0])):
                        if matrix[i+directions[1][0]][j+directions[1][1]] == 0:
                            matrix[i+directions[1][0]][j+directions[1][1]] = 2
                    # left
                    if (0 <= i+directions[2][0] < len(matrix)) and (0 <= j+directions[2][1] < len(matrix[0])):
                        if matrix[i+directions[2][0]][j+directions[2][1]] == 0:
                            matrix[i+directions[2][0]][j+directions[2][1]] = 2
                    # up 
                    if (0 <= i+directions[3][0] < len(matrix)) and (0<= j+directions[3][1] < len(matrix[0])):
                        if matrix[i+directions[3][0]][j+directions[3][1]] == 0:
